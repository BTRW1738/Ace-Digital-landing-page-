...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Enhanced Floating Elements - Starry sky animated blue dots */}
      ...
      {/* Social Media Links - Positioned in Bottom Right to Avoid Text Overlap */}
      <div className="absolute bottom-8 right-8 z-30">
        <div className="flex space-x-4">
          ...
          <a
            ...
            className="group flex items-center justify-center w-12 h-12 bg-slate-900/90 backdrop-blur-lg rounded-full border border-slate-700/60 hover:border-cyan-400/60 shadow-xl hover:shadow-cyan-400/20 transition-all duration-300 hover:scale-110"
            aria-label="Follow us on Instagram"
          >
            <svg className="w-6 h-6 text-cyan-400 group-hover:text-cyan-300 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
