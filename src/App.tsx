      ...
      <div className="absolute top-6 right-6 sm:top-8 sm:right-8 z-30">
        <div className="flex flex-col space-y-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-center w-12 h-12 bg-slate-900/90 backdrop-blur-lg rounded-full border border-slate-700/60 hover:border-cyan-400/60 shadow-2xl hover:shadow-cyan-400/20 transition-all duration-300 hover:scale-110"
